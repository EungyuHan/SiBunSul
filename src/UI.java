...
//	    uif.submitButton.addActionListener(new ActionListenerEditMemberSubmit(av.Roster, uif.submitButton, uif.tf2, uif.tf3, uif.tf4, uif.tf5, uif.tf6, uif.l2, uif.l4, uif.l5, uif.l6, uif.l7, uif.l8));
