...
public class ActionListenerViewStats implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		l4.setText(timeRecordAll.get(timeRecordAll.size() - 1).getName());
		l5.setText(timeRecordAll.get(timeRecordAll.size() - 2).getName());
		l6.setText(timeRecordAll.get(timeRecordAll.size() - 3).getName());
		l7.setText(timeRecordAll.get(timeRecordAll.size() - 4).getName());
		l8.setText(timeRecordAll.get(timeRecordAll.size() - 5).getName());
		l9.setText(timeRecordAll.get(timeRecordAll.size() - 6).getName());
		l10.setText(timeRecordAll.get(timeRecordAll.size() - 7).getName());
		l11.setText(timeRecordAll.get(timeRecordAll.size() - 8).getName());
		l12.setText(timeRecordAll.get(timeRecordAll.size() - 9).getName());
		l13.setText(timeRecordAll.get(timeRecordAll.size() - 10).getName());
		l14.setText(timeRecordAll.get(timeRecordAll.size() - 11).getName());
		l15.setText(timeRecordAll.get(timeRecordAll.size() - 12).getName());
		
		l17.setText(timeRecordAll.get(timeRecordAll.size() - 1).getSwimEvent());
		l18.setText(timeRecordAll.get(timeRecordAll.size() - 2).getSwimEvent());
		l19.setText(timeRecordAll.get(timeRecordAll.size() - 3).getSwimEvent());
		l20.setText(timeRecordAll.get(timeRecordAll.size() - 4).getSwimEvent());
		l21.setText(timeRecordAll.get(timeRecordAll.size() - 5).getSwimEvent());
		l22.setText(timeRecordAll.get(timeRecordAll.size() - 6).getSwimEvent());
		l23.setText(timeRecordAll.get(timeRecordAll.size() - 7).getSwimEvent());
		l24.setText(timeRecordAll.get(timeRecordAll.size() - 8).getSwimEvent());
		l25.setText(timeRecordAll.get(timeRecordAll.size() - 9).getSwimEvent());
		l26.setText(timeRecordAll.get(timeRecordAll.size() - 10).getSwimEvent());
		l27.setText(timeRecordAll.get(timeRecordAll.size() - 11).getSwimEvent());
		l28.setText(timeRecordAll.get(timeRecordAll.size() - 12).getSwimEvent());
		
		l30.setText(timeRecordAll.get(timeRecordAll.size() - 1).getSwimTime());
		l31.setText(timeRecordAll.get(timeRecordAll.size() - 2).getSwimTime());
		l32.setText(timeRecordAll.get(timeRecordAll.size() - 3).getSwimTime());
		l33.setText(timeRecordAll.get(timeRecordAll.size() - 4).getSwimTime());
		l34.setText(timeRecordAll.get(timeRecordAll.size() - 5).getSwimTime());
		l35.setText(timeRecordAll.get(timeRecordAll.size() - 6).getSwimTime());
		l36.setText(timeRecordAll.get(timeRecordAll.size() - 7).getSwimTime());
		l37.setText(timeRecordAll.get(timeRecordAll.size() - 8).getSwimTime());
		l38.setText(timeRecordAll.get(timeRecordAll.size() - 9).getSwimTime());
		l39.setText(timeRecordAll.get(timeRecordAll.size() - 10).getSwimTime());
		l40.setText(timeRecordAll.get(timeRecordAll.size() - 11).getSwimTime());
		l41.setText(timeRecordAll.get(timeRecordAll.size() - 12).getSwimTime());
